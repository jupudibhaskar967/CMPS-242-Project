...
maxoccurrence = min(len(dictionary.keys()), 5000)
...
ret = optimize.fmin_l_bfgs_b(neg_log_likelihood, np.zeros((train_X.shape[1],no_of_classes)), fprime=gradient, args=(train_X,train_y))
res = ret[0].reshape((train_X.shape[1],no_of_classes))
