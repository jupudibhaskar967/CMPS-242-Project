...
We used fmin\_l\_bfgs and stochastic gradient descent to minimize the cost function and obtain W. fmin\_l\_bfgs is from scipy.optimize module in python. It uses the gradient that we calculated above in minimizing the cost function.
